    ...
    <form action="" method="POST">
        <table class="no-border">
            <tr>
                ...
                <td><input type="text" name="quiz_title" class="input-field"></td>
            </tr>
            <tr>
                <td>Description:</td>
            ...
            <tr>
                <td>Total Mark:</td>
                <td><input type="number" name="total_mark" class="input-field"></td>
            </tr>
            <tr>
                <td>Time:</td>
                <td><input type="text" name="quiz_time" class="input-field"></td>
            </tr>
        </table>
        <table>
            <tr>
